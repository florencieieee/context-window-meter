---
title: Privacy Policy — Context Window Meter for ChatGPT
---

<!--
  This is the copy published via GitHub Pages and linked from the Chrome Web
  Store listing. It must stay identical in substance to /PRIVACY.md.
-->
